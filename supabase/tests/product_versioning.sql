...
values ('21212121-2121-2121-2121-212121212121', 'Produit R1', 10000, 100000, 3, 12, 1, 'CONSTANT_INSTALLMENT');
...
select lives_ok($$ select public.revise_loan_product(
  ...
  '{"name":"Produit R2","minAmount":20000,"maxAmount":150000,"minDurationMonths":3,"maxDurationMonths":12,"interestRate":1.1,"processingFeePercent":0,"processingFeeFlat":0,"managementFeePercent":0,"managementFeeFlat":0,"insuranceRate":0,"guaranteeRate":10,"mandatorySavingsRate":0,"latePenaltyRate":0.1,"isActive":true}'
...
select throws_ok($$ update public.loan_products set interest_rate = 1.3 where id = '21212121-2121-2121-2121-212121212121' $$,
